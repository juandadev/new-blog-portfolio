export const metadata = {
  ...
  coverImage:
    'https://raw.githubusercontent.com/juandadev/assets-blog/refs/heads/main/despedida-trabajo-sonado/cover.webp',
  originalPostUrl:
    'https://dev.to/juandadev/how-i-got-fired-from-my-dream-job-56hf',
  tags: ['journal'],
  description:
    "It's tough when you fall in love with the company more than with your own work. Let's remember we're just another number, always replaceable.",
};
