...
description: "This isn't a tutorial, it's a devlog about my journey working with Next.js server components, and the importance of not blindly trusting AI but actually reading the official documentation."
author:
  name: "Juan Daniel Martínez"
  profilePicture: "https://avatars.githubusercontent.com/u/38818606?v=4"
---

When I set out to build my personal blog with **Next.js 15**, I was excited to finally take advantage of the famous **✨ Server Components ✨**. I had never really given them a proper try before, and I thought, *"This is the future."* What I didn't know is that I was about to step into a world of bugs, broken builds, missing sessions, and documentation that was… confusing?
...
I thought this project would be *"simple"*, but here I was, asking ChatGPT, then Grok because **✨ free tier ✨**, taking a coffee-break ☕️ when I finally remembered that I do have a brain, and that back in the day we used **Google and StackOverflow** to solve things. Then came the eureka moment:
...
:::detault
I was looking through my Twitter bookmarks and found [this tweet from @asidorenko_](https://x.com/asidorenko_/status/1884710772040679432) explaining why you should separate your DB calls. I knew I'd read that somewhere.
:::
...
I once read (maybe on Reddit or Twitter) that a common question is: *"When should I use use client?"* The answer was simple: **use server components by default**, and only move the interactive parts to client components when absolutely necessary, even if it feels silly.
...
:::default
While writing this post, I found [another tweet by @asidorenko_](https://x.com/asidorenko_/status/1865864202625147378) explaining how to separate the interactive part into a new component. I swear I'm not sponsored by him, go follow him if you're into Next.js content.
:::
