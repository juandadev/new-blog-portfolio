import { serverComponentsPolaroidImages } from '@/content/polaroid-manifests/blog/server-components-in-nextjs-15-what-i-got-wrong-and-right';
...
<Frame image={serverComponentsPolaroidImages.porUnDemonio} maxWidth={640}>
  <FrameFooter>
