...
export const vaultStory: VaultStory = {
  ...
  headline: 'The Story',
  intro:
    "This section is a mix of nostalgia and proof of my work as a designer-wannabe.\n\nThis shaped my taste and the need to make the web a beautiful place. Sadly I stopped doing this to focus more on my engineering path, but now in this AI era and agents writing better code than me, I'm betting again on good quality designs, do you think I was going somewhere or I was another average Joe?\n\nWhile pursuing my Design Engineer path, I was revisiting my old projects. It's good to have it here as part of my portfolio, and to tell myself that I can do better than this. Feedback is always welcome :)",
